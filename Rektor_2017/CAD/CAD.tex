...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|}
		\hline
		\textbf{Proizvođač} &Changzhou Songyang Machinery \& Electronics Co. \\ \hline 
...
Kretanje mase po kraku je linijsko. Kako bi kretanje mase imalo minimalno trenje, odabran je klizni mehanizam prikazan Slikom \ref{fig:klizni_mehanizam}. Klizni mehanizam montiran je s donje strane kraka, a za aluminijsku kvadratnu cijev pričvršćen je s dva vijka. Klizni mehanizam se sastoji od vodilice i kolica. Na kolicima se nalazi klizni mehanizam koji se sastoji od sitnih kuglica koje omogućavaju klizno gibanje s malim trenjem. Na kolica kliznog mehanizma montirano je posebno konstruiran prihvat koračnog motora (Slika \ref{fig:stepper_bracket}), kojim se koračni motor učvršćuje na klizni mehanizam.
