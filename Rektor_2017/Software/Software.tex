...
\subsubsection{Ostale komponente programske podrške kontrolera koračnih motora}
...
cjeline, a sa ostalim modula komuniciraju korištenjem redova poruka (eng. \textit{message queues}). Cjeloviti programski kod je javno dostupan na GitHub servisu \cite{github}.
\begin{center}
	\centering
