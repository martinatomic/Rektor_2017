...
\vspace{0.5cm}
\begin{Huge}
	Design and development of a small-scale multi-rotor UAV with moving mass control
\end{Huge}
\vspace*{\fill}
...
\input{Ciljevi/Ciljevi}

\newpage
\section{Materijal i metode}
\input{Materijal/Materijal}
